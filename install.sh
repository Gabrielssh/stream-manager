...
start_bot_telegram(){
    ...
    echo "Iniciando Bot Telegram IPTV PRO..."
    systemctl start iptv_bot 2>/dev/null || {
        cat > /etc/systemd/system/iptv_bot.service <<EOF2
[Unit]
...
EOF2
    ...
    echo "✅ Bot Telegram iniciado! Converse com ele no Telegram."
    pause
}
